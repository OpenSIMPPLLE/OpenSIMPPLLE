...
//    DatabaseCreator.closeHibernate();
  ...
  private void openAccessTextFiles() throws SimpplleError, IOException {
    ...
    for (int run=0; run<numSimulations; run++) {
      ...
      accessEvuSimDataOut[run].println("RUN,TIMESTEP,SEASON_ID,SLINK,LIFEFORM_ID,SPECIES_ID,SIZECLASS_ID,AGE,DENSITY_ID,PROCESS_ID,PROB,PROBSTR,TREATMENT_ID,ORIGINUNITID,PROCESS_RULE,FIRE_REGENERATION_RULE,SUCCESSION_REGENERATION_RULE");
    }
