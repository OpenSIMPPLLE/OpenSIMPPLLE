  ...
  public void writeLog() throws IOException {
    ...
    try (PrintWriter writer = new PrintWriter(new FileOutputStream(file))) {
      ...
      writer.write("SIMPPLLE Simulation Log File\n"
                 ...
                 + "Data Files\n"
                 + "\n"
                 + "Unit Attributes        : " + ((attributesAll    == null) ? "Not Loaded" : attributesAll) + "\n"
                 + "Spatial Relationships  : " + ((spatialRelate    == null) ? "Not Loaded" : spatialRelate) + "\n"
                 ...
                 + "Climate                : " + ((climateStr       == null) ? "Default" : climateStr) + "\n"
                 + "Treatment Schedule     : " + ((trtSched         == null) ? "Default" : trtSched) + "\n"
                 + "Treatment Logic        : " + ((trtLogic         == null) ? "Default" : trtLogic) + "\n"
                 + "Process Prob Logic     : " + ((processProbLogic == null) ? "Default" : processProbLogic) + "\n"
                 ...
                 + "FireWthrSupp Cls A     : " + ((fireSuppWthrClA  == null) ? "Default" : fireSuppWthrClA) + "\n"
                 + "FireWthrSupp Bey Cls A : " + ((fireSuppWthrBClA == null) ? "Default" : fireSuppWthrBClA) + "\n"
