...
public class HighWindthrow extends Process {
  ...
  /**
   * Constructor.  Inherits from superclass Process and initializes spreading to false and the visible columngs
   */
  public HighWindthrow() {
    super();

    spreading   = false;
    description = "High Windthrow";
