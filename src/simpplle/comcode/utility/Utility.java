 ...
 *
 * <p>This class contains methods for a bunch of essential functions which fall under the category of file management like making file pathways, etc...
 * 
 ...
 * @param value
 */
  public static void sort(ArrayList<simpplle.comcode.element.Evu> key, ArrayList<MyInteger> value) {
    boolean swapped;
    int     i=0, j, tmp;
    simpplle.comcode.element.Evu val;
 ...
 * @param value
 */
  public static void sort(simpplle.comcode.element.Evu[] key, int[] value) {
    boolean swapped;
    int     i=0, j, tmp;
    simpplle.comcode.element.Evu val;
