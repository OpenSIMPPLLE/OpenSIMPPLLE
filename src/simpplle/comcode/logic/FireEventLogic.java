...
//    fireData.addStructure(structure);
  ...
  public ProcessType getSpreadingTypeOfFire(ProcessType process,
                                            ...
                                            simpplle.comcode.element.Evu fromEvu, simpplle.comcode.element.Evu evu, Lifeform toLifeform) {
   ...
   * @return ProcessType
   */
  public ProcessType getTypeOfFire(FireResistance resistance, simpplle.comcode.element.Evu evu, Lifeform lifeform) {
  ...
  public boolean isWithinMaxFireSpottingDistance(simpplle.comcode.element.Evu fromEvu, simpplle.comcode.element.Evu toEvu) {
   ...
   */
  public int getFireSpottingProbability(simpplle.comcode.element.Evu fromEvu, simpplle.comcode.element.Evu toEvu, ProcessType simFireProcess, boolean isExtremeSpread) {
