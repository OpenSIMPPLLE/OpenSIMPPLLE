 ...
 *
 * <p>This class defines Fire Type Logic Data, a type of Logic Data
 * 
 ...
 */
  ...
  public Object getValueAt(int col) {
    switch (col) {
      case simpplle.comcode.logic.FireEventLogic.WETTER_COL:           return wetter.getShortName();
      case simpplle.comcode.logic.FireEventLogic.NORMAL_COL:           return normal.getShortName();
      case simpplle.comcode.logic.FireEventLogic.DRIER_COL:            return drier.getShortName();
      default: return super.getValueAt(col);
    }
  }
  public void setValueAt(int col, Object value) {
    switch (col) {
      case simpplle.comcode.logic.FireEventLogic.WETTER_COL:           wetter = ProcessType.get((String)value); break;
      case simpplle.comcode.logic.FireEventLogic.NORMAL_COL:           normal = ProcessType.get((String)value); break;
      case simpplle.comcode.logic.FireEventLogic.DRIER_COL:            drier  = ProcessType.get((String)value); break;
      default:
   ...
   */
  public ProcessType getFireTypeIfMatch(FireResistance resistance, simpplle.comcode.element.Evu evu, Lifeform lifeform) {
