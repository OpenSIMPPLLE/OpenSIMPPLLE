 ...
 * @since V2.2
 * 
 * @see TreatmentLogicData
 */


public class ChangeLogic extends simpplle.comcode.TreatmentLogicData {
 ...
 */
  ...
  protected Boolean doCallFunction(simpplle.comcode.element.Evu evu) {
     ...
     */
  public String doChange(Treatment treatment, simpplle.comcode.element.Evu evu) {
