...
public class FireSuppProductionRateLogicData extends LogicData {
  ...
  public Object getValueAt(int col) {
    switch (col) {
      case simpplle.comcode.logic.FireSuppProductionRateLogic.MIN_EVENT_ACRES_COL:  return getNonRationalAcres(acresRange.getLower());
      case simpplle.comcode.logic.FireSuppProductionRateLogic.MAX_EVENT_ACRES_COL:  return getNonRationalAcres(acresRange.getUpper());
      case simpplle.comcode.logic.FireSuppProductionRateLogic.SLOPE_COL:            return slope;
      case simpplle.comcode.logic.FireSuppProductionRateLogic.RATE_COL:             return rate;
      default: return super.getValueAt(col);
    }
  }
  public void setValueAt(int col, Object value) {
    switch (col) {
      case simpplle.comcode.logic.FireSuppProductionRateLogic.MIN_EVENT_ACRES_COL:
      {
      ...
      case simpplle.comcode.logic.FireSuppProductionRateLogic.MAX_EVENT_ACRES_COL:
      {
        int acres = Area.getRationalAcres((Integer)value);
      ...
      case simpplle.comcode.logic.FireSuppProductionRateLogic.SLOPE_COL:
      {
        slope = (Float)value;
        markChanged();
        break;
      }
      case simpplle.comcode.logic.FireSuppProductionRateLogic.RATE_COL:
      {
