 ...
 *
 * <p>This class has methods pertaining to Competition Data, a type of LogicData. 
 * 
  ...
  public void doAction(simpplle.comcode.element.Evu evu) {
    ...
    for (int l=0; l<changeLifeforms.size(); l++) {
      ...
      if (veg != null) {
        ...
        state.setProb((short) simpplle.comcode.element.Evu.COMP);
      }
    }
  }
/**
 ...
 */
  public Object getValueAt(int col) {
    switch (col) {
      case simpplle.comcode.logic.DoCompetitionLogic.SELECTED_COL:         return selected;
      case simpplle.comcode.logic.DoCompetitionLogic.LIFEFORM_COL:         return lifeform;
      case simpplle.comcode.logic.DoCompetitionLogic.MIN_CANOPY_COL:       return minCanopy;
      case simpplle.comcode.logic.DoCompetitionLogic.MAX_CANOPY_COL:       return maxCanopy;
      case simpplle.comcode.logic.DoCompetitionLogic.DENSITY_CHANGE_COL:   return densityChange;
      case simpplle.comcode.logic.DoCompetitionLogic.CHANGE_LIFEFORMS_COL: return changeLifeforms;
      case simpplle.comcode.logic.DoCompetitionLogic.ACTION_COL:           return action;
  ...
  public void setValueAt(int col, Object value) {
    switch (col) {
      case simpplle.comcode.logic.DoCompetitionLogic.SELECTED_COL:
        if (selected != (Boolean)value) {
          selected = (Boolean) value;
          SystemKnowledge.markChanged(sysKnowKind);
        }
        break;
      case simpplle.comcode.logic.DoCompetitionLogic.LIFEFORM_COL:
        setLifeform((Lifeform)value);
        break;
      case simpplle.comcode.logic.DoCompetitionLogic.MIN_CANOPY_COL:
        if (minCanopy != (Integer)value) {
          minCanopy = (Integer) value;
          SystemKnowledge.markChanged(sysKnowKind);
        }
        break;
      case simpplle.comcode.logic.DoCompetitionLogic.MAX_CANOPY_COL:
        if (maxCanopy != (Integer)value) {
          maxCanopy = (Integer) value;
          SystemKnowledge.markChanged(sysKnowKind);
        }
        break;
      case simpplle.comcode.logic.DoCompetitionLogic.DENSITY_CHANGE_COL:
        if (densityChange != (DensityChange)value) {
          densityChange = (DensityChange) value;
          SystemKnowledge.markChanged(sysKnowKind);
        }
        break;
      case simpplle.comcode.logic.DoCompetitionLogic.CHANGE_LIFEFORMS_COL: /* Set by dialog code */
        break;
      case simpplle.comcode.logic.DoCompetitionLogic.ACTION_COL:
