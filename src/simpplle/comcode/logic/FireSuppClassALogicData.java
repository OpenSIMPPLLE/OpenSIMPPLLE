 ...
 *
 * <p>This class defines Fire Suppression Class A Logic Data, a type of Logic Data
 *
 * Fire Process logic
...
//    logicData.roadStatusList = new ArrayList<Roads.Status>(roadStatusList);
  ...
  public Object getValueAt(int col) {
    switch (col) {
      case simpplle.comcode.logic.FireSuppClassALogic.PROB_COL:        return prob;
//      case FireSuppClassALogic.ROAD_STATUS_COL: return roadStatusList;
  ...
  public void setValueAt(int col, Object value) {
    switch (col) {
      case simpplle.comcode.logic.FireSuppClassALogic.PROB_COL:
  ...
  public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
    ...
    if (version == 1) {
      ...
      for (String statusName : tmpList) {
        roadStatusList.add(simpplle.comcode.element.Roads.Status.lookup(statusName));
      }
    }
    else if (version == 2) {
