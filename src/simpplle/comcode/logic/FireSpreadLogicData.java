 ...
 */
  ...
  public Object getValueAt(int col) {
    switch (col) {
      case simpplle.comcode.logic.FireEventLogic.ORIGIN_PROCESS_COL:   return getOriginProcessListDesc();
      case simpplle.comcode.logic.FireEventLogic.POSITION_COL: return positions;
      case simpplle.comcode.logic.FireEventLogic.AVERAGE_COL:  return average.getShortName();
      case simpplle.comcode.logic.FireEventLogic.EXTREME_COL:  return extreme.getShortName();
  ...
  public void setValueAt(int col, Object value) {
    switch (col) {
      case simpplle.comcode.logic.FireEventLogic.POSITION_COL: break;
      case simpplle.comcode.logic.FireEventLogic.AVERAGE_COL:  average  = ProcessType.get((String)value); break;
      case simpplle.comcode.logic.FireEventLogic.EXTREME_COL:  extreme  = ProcessType.get((String)value); break;
      default:
 ...
 */
  ...
  public ProcessType getFireTypeIfMatch(ProcessType process,
                                        ...
                                        simpplle.comcode.element.Evu fromEvu, simpplle.comcode.element.Evu evu, Lifeform lifeform) {
    ...
    switch (fromEvu.getAdjPosition(evu)) {
      case simpplle.comcode.element.Evu.ABOVE: adjPosition = ABOVE; break;
      case simpplle.comcode.element.Evu.BELOW: adjPosition = BELOW; break;
      case simpplle.comcode.element.Evu.NEXT_TO: adjPosition = NEXT_TO; break;
    }
...
//    }
    ...
    int prob = (isExtreme) ? simpplle.comcode.element.Evu.SE : simpplle.comcode.element.Evu.S;
