 ...
 */
   ...
   */
  public boolean doChange(simpplle.comcode.element.Evu evu, Lifeform lifeform,
...
//    evu.updateInvasiveTrackSpecies(changeRate,lifeform);
  ...
  public boolean isMatch(simpplle.comcode.element.Evu evu, InclusionRuleSpecies species) {
 ...
 */
  ...
  public Object getValueAt(int col) {
    switch (col) {
      ...
      case simpplle.comcode.logic.InvasiveSpeciesLogic.CHANGE_RATE_COL:            return changeRate;
      case simpplle.comcode.logic.InvasiveSpeciesLogic.CHANGE_AS_PERCENT_COL:      return changeAsPercent;
      case simpplle.comcode.logic.InvasiveSpeciesLogic.STATE_CHANGE_THRESHOLD_COL: return stateChangeThreshold;
      default:
  ...
  public void setValueAt(int col, Object value) {
    switch (col) {
      case simpplle.comcode.logic.InvasiveSpeciesLogic.INVASIVE_SPECIES_COL: break;
      case simpplle.comcode.logic.InvasiveSpeciesLogic.CHANGE_RATE_COL:
        if (changeRate != (Integer)value) {
          changeRate = (Integer) value;
          SystemKnowledge.markChanged(sysKnowKind);
        }
        break;
      case simpplle.comcode.logic.InvasiveSpeciesLogic.CHANGE_AS_PERCENT_COL:
        if (changeAsPercent != (Boolean)value) {
          changeAsPercent = (Boolean) value;
          SystemKnowledge.markChanged(sysKnowKind);
        }
        break;
      case simpplle.comcode.logic.InvasiveSpeciesLogic.STATE_CHANGE_THRESHOLD_COL:
