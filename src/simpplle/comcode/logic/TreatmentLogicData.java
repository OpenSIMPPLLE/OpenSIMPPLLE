...
public abstract class TreatmentLogicData {
  ...
  protected void read(simpplle.comcode.utility.StringTokenizerPlus strTok)
...
//      numPrinted += str.length();
  ...
  protected Boolean isMemberHtGrp(simpplle.comcode.element.Evu evu) {
  ...
  protected Boolean isMemberSpecies(simpplle.comcode.element.Evu evu, VegSimStateData state) {
  ...
  protected Boolean isMemberSizeClass(simpplle.comcode.element.Evu evu, VegSimStateData state) {
    if (state == null) { return null; }
  ...
  protected Boolean isMemberDensity(simpplle.comcode.element.Evu evu, VegSimStateData state) {
    if (state == null) { return null; }
  ...
  protected Boolean isStateMatch(simpplle.comcode.element.Evu evu, VegSimStateData state) {
    if (state == null) { return null; }
  ...
  protected abstract Boolean doCallFunction(simpplle.comcode.element.Evu evu);

  public Boolean evaluateConditionals(simpplle.comcode.element.Evu evu) {
