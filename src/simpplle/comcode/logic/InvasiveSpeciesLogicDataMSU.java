...
/*
    ...
    protected boolean            defaultTreatCoeffDataDesc;
*/
  public boolean isMatch(simpplle.comcode.element.Evu evu) {
 ...
 */
  private void printProbabilityData(simpplle.comcode.element.Evu evu, int prob) {
 ...
 * @return
 */
  public int calculateProbability(simpplle.comcode.element.Evu evu, double distRoad, double distTrail) {
    ArrayList<simpplle.comcode.element.ExistingLandUnit> landUnits = evu.getAssociatedLandUnits();
    if (landUnits == null || landUnits.size() == 0) { return 0; }

    simpplle.comcode.element.ExistingLandUnit elu = landUnits.get(0);
 ...
 */
  public Object getValueAt(int col) {
    switch (col) {
      case simpplle.comcode.logic.InvasiveSpeciesLogicMSU.INVASIVE_SPECIES_COL: return invasiveSpeciesDesc;
      case simpplle.comcode.logic.InvasiveSpeciesLogicMSU.INTERCEPT_COL:        return intercept;
      case simpplle.comcode.logic.InvasiveSpeciesLogicMSU.ELEV_COL:             return elevCoeff;
      case simpplle.comcode.logic.InvasiveSpeciesLogicMSU.SLOPE_COL:            return slopeCoeff;
      case simpplle.comcode.logic.InvasiveSpeciesLogicMSU.C0SASP_COL:           return cosaspCoeff;
      case simpplle.comcode.logic.InvasiveSpeciesLogicMSU.SINASP_COL:           return sinaspCoeff;
      case simpplle.comcode.logic.InvasiveSpeciesLogicMSU.ANNRAD_COL:           return annradCoeff;
      case simpplle.comcode.logic.InvasiveSpeciesLogicMSU.DISTROAD_COL:         return distroadCoeff;
      case simpplle.comcode.logic.InvasiveSpeciesLogicMSU.DISTTRAIL_COL:        return disttrailCoeff;
      case simpplle.comcode.logic.InvasiveSpeciesLogicMSU.PROCESS_COEFF_COL:    return processCoeffDataDesc;
      case simpplle.comcode.logic.InvasiveSpeciesLogicMSU.TREATMENT_COEFF_COL:  return treatCoeffDataDesc;
      case simpplle.comcode.logic.InvasiveSpeciesLogicMSU.SHRUB_COL:            return shrubCoeff;
      case simpplle.comcode.logic.InvasiveSpeciesLogicMSU.GRASS_COL:            return grassCoeff;
      case simpplle.comcode.logic.InvasiveSpeciesLogicMSU.TREE_COL:             return treeCoeff;
      case simpplle.comcode.logic.InvasiveSpeciesLogicMSU.START_VALUE_COL:      return startValue;
      default:
  ...
  public void setValueAt(int col, Object value) {
    switch (col) {
      case simpplle.comcode.logic.InvasiveSpeciesLogicMSU.INVASIVE_SPECIES_COL: break; // set in table editor;
      case simpplle.comcode.logic.InvasiveSpeciesLogicMSU.INTERCEPT_COL:
        intercept = (Double)value;
        SystemKnowledge.markChanged(sysKnowKind);
        break;
      case simpplle.comcode.logic.InvasiveSpeciesLogicMSU.ELEV_COL:
        elevCoeff = (Double)value;
        SystemKnowledge.markChanged(sysKnowKind);
        break;
      case simpplle.comcode.logic.InvasiveSpeciesLogicMSU.SLOPE_COL:
        slopeCoeff = (Double)value;
        SystemKnowledge.markChanged(sysKnowKind);
        break;
      case simpplle.comcode.logic.InvasiveSpeciesLogicMSU.C0SASP_COL:
        cosaspCoeff = (Double)value;
        SystemKnowledge.markChanged(sysKnowKind);
        break;
      case simpplle.comcode.logic.InvasiveSpeciesLogicMSU.SINASP_COL:
        sinaspCoeff = (Double)value;
        SystemKnowledge.markChanged(sysKnowKind);
        break;
      case simpplle.comcode.logic.InvasiveSpeciesLogicMSU.ANNRAD_COL:
        annradCoeff = (Double)value;
        SystemKnowledge.markChanged(sysKnowKind);
        break;
      case simpplle.comcode.logic.InvasiveSpeciesLogicMSU.DISTROAD_COL:
        distroadCoeff = (Double)value;
        SystemKnowledge.markChanged(sysKnowKind);
        break;
      case simpplle.comcode.logic.InvasiveSpeciesLogicMSU.DISTTRAIL_COL:
        disttrailCoeff = (Double)value;
        SystemKnowledge.markChanged(sysKnowKind);
        break;
      case simpplle.comcode.logic.InvasiveSpeciesLogicMSU.SHRUB_COL:
        shrubCoeff = (Double)value;
        SystemKnowledge.markChanged(sysKnowKind);
        break;
      case simpplle.comcode.logic.InvasiveSpeciesLogicMSU.GRASS_COL:
        grassCoeff = (Double)value;
        SystemKnowledge.markChanged(sysKnowKind);
        break;
      case simpplle.comcode.logic.InvasiveSpeciesLogicMSU.TREE_COL:
        treeCoeff = (Double)value;
        SystemKnowledge.markChanged(sysKnowKind);
        break;
      case simpplle.comcode.logic.InvasiveSpeciesLogicMSU.START_VALUE_COL:
        if (startValue != (Integer)value) {
          startValue = (Integer)value;
          SystemKnowledge.markChanged(sysKnowKind);
        }
        break;
      case simpplle.comcode.logic.InvasiveSpeciesLogicMSU.PROCESS_COEFF_COL:    break; // set in table editor;
      case simpplle.comcode.logic.InvasiveSpeciesLogicMSU.TREATMENT_COEFF_COL:  break; // set in table editor;
      default:
