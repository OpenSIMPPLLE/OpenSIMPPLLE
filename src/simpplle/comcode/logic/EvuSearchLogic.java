...
/**
 * adds a row by inserting position, system knowledge kind, and instance of AbstractLogicData by calling the superclass simpplle.comcode.logic.BaseLogic addRow method
 */
...
/**
 * 
 * dublicates a row by getting the abstract logic data from  from row, then position, system knowledge kind, and instance of AbstractLogicData are passed to the superclass simpplle.comcode.logic.BaseLogic addRow method
 ...
 */
  public ArrayList<simpplle.comcode.element.Evu> findMatchingUnits(int row) {
    ArrayList<simpplle.comcode.element.Evu> units = new ArrayList<simpplle.comcode.element.Evu>();
