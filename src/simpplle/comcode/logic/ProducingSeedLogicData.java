...
public class ProducingSeedLogicData extends LogicData {
  ...
  private ArrayList<simpplle.comcode.element.Evu.RegenTypes> regenTypes;
  ...
  public ProducingSeedLogicData() {
    ...
    regenTypes     = new ArrayList<simpplle.comcode.element.Evu.RegenTypes>();
    prob = 100;
 ...
 */
  public void setRegenTypes(ArrayList<simpplle.comcode.element.Evu.RegenTypes> newList) {
    regenTypes = new ArrayList<simpplle.comcode.element.Evu.RegenTypes>(newList);
    markChanged();
  }
  public Object getValueAt(int col) {
    switch (col) {
      case simpplle.comcode.logic.ProducingSeedLogic.REGEN_TYPE_COL:     return regenTypes;
      case simpplle.comcode.logic.ProducingSeedLogic.PRODUCING_SEED_COL: return prob;
      default: return super.getValueAt(col);
    }
  }
  public void setValueAt(int col, Object value) {
    switch (col) {
      case simpplle.comcode.logic.ProducingSeedLogic.PRODUCING_SEED_COL:
        ...
        break;
      case simpplle.comcode.logic.ProducingSeedLogic.REGEN_TYPE_COL:
        // set by editor
        break;
      default:
 ...
 */
  public boolean isMatch(simpplle.comcode.element.Evu evu, Integer tStep, Lifeform lifeform,
                         VegetativeType vegType, simpplle.comcode.element.Evu.RegenTypes regenType)
  {
 ...
 */
  public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
    ...
    regenTypes    = (ArrayList<simpplle.comcode.element.Evu.RegenTypes>)in.readObject();
    if (version == 1) {
