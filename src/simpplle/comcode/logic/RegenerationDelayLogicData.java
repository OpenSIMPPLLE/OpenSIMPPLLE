 ...
 */
   ...
   */
  public int getDelay(simpplle.comcode.element.Evu evu, Lifeform lifeform) {
 ...
 */
  public Object getValueAt(int col) {
    switch (col) {
      case simpplle.comcode.logic.RegenerationDelayLogic.DELAY_COL: return delay;
  ...
  public void setValueAt(int col, Object value) {
    switch (col) {
      case simpplle.comcode.logic.RegenerationDelayLogic.DELAY_COL:
