 ...
 */
  public Object getValueAt(int col) {
    switch (col) {
      case simpplle.comcode.logic.FireSuppSpreadRateLogic.SLOPE_COL:        return slope;
      case simpplle.comcode.logic.FireSuppSpreadRateLogic.AVERAGE_RATE_COL: return averageRate;
      case simpplle.comcode.logic.FireSuppSpreadRateLogic.EXTREME_RATE_COL: return extremeRate;
  ...
  public void setValueAt(int col, Object value) {
    switch (col) {
      case simpplle.comcode.logic.FireSuppSpreadRateLogic.SLOPE_COL:
      {
        slope = (Float)value;
        markChanged();
        break;
      }
      case simpplle.comcode.logic.FireSuppSpreadRateLogic.AVERAGE_RATE_COL:
      {
      ...
      case simpplle.comcode.logic.FireSuppSpreadRateLogic.EXTREME_RATE_COL:
      {
        int newValue = (Integer) value;
