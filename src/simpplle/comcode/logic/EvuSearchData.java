 ...
 */
  public Object getValueAt(int col) {
    switch (col) {
      case simpplle.comcode.logic.EvuSearchLogic.TIME_STEP_COL:    return timeStepList;
      case simpplle.comcode.logic.EvuSearchLogic.AGE_COL:          return ageList;
      case simpplle.comcode.logic.EvuSearchLogic.FMZ_COL:          return fmzList;
      case simpplle.comcode.logic.EvuSearchLogic.PROB_COL:         return probList;
      default: return super.getValueAt(col);
    }
  }
  
  /**
   * Sets the column value of time step, age, fire management zone, and probability by calling the simpplle.comcode.logic.LogicData superclass method setValueAt
   */
  public void setValueAt(int col, Object value) {
    switch (col) {
      case simpplle.comcode.logic.EvuSearchLogic.TIME_STEP_COL:    break;
      case simpplle.comcode.logic.EvuSearchLogic.AGE_COL:          break;
      case simpplle.comcode.logic.EvuSearchLogic.FMZ_COL:          break;
      case simpplle.comcode.logic.EvuSearchLogic.PROB_COL:         break;
      default:
 ...
 */
  public ArrayList getPossibleValues(int col) {
    switch (col) {
      case simpplle.comcode.logic.EvuSearchLogic.TIME_STEP_COL:
      ...
      case simpplle.comcode.logic.EvuSearchLogic.AGE_COL:
...
//        return Simpplle.getCurrentArea().getAllOwnership();
      ...
      case simpplle.comcode.logic.EvuSearchLogic.FMZ_COL:
...
//        return new ArrayList<Roads.Status>(Arrays.asList(Roads.Status.values()));
      ...
      case simpplle.comcode.logic.EvuSearchLogic.PROB_COL:
        return simpplle.comcode.element.Evu.getAllProbabilitySpecial();
