 ...
 */
  public void doAction(simpplle.comcode.element.Evu evu, Lifeform lifeform) {
    ...
    state.setProb((short) simpplle.comcode.element.Evu.GAP);
  }

  public Object getValueAt(int col) {
    switch (col) {
      case simpplle.comcode.logic.GapProcessLogic.GAP_PROCESS_COL: return gapProcess;
      case simpplle.comcode.logic.GapProcessLogic.PROB_COL:        return prob;
  ...
  public void setValueAt(int col, Object value) {
    switch (col) {
      case simpplle.comcode.logic.GapProcessLogic.GAP_PROCESS_COL:
        if (gapProcess != (ProcessType)value) {
          gapProcess = (ProcessType)value;
        }
        break;
      case simpplle.comcode.logic.GapProcessLogic.PROB_COL:
