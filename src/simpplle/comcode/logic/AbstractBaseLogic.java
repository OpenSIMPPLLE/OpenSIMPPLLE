 ...
 * @return
 */
  public ArrayList<AbstractLogicData> getData(String kind) {
    return data.get(kind.toString());
  }
  public ArrayList<AbstractLogicData> getData(String kind, boolean addifNull) {
 ...
 */
    ...
    throws IOException, ClassNotFoundException
  {
    if (version == 2) {
      ...
      ArrayList<simpplle.comcode.logic.LogicData> list = (ArrayList<LogicData>)in.readObject();
    ...
    for (int i = 0; i < size; i++) {
      ...
      if (list != null) {
        for (int l = 0; l < list.size(); l++) {
          ...
          if (col > simpplle.comcode.logic.BaseLogic.LAST_COL) {
