 ...
 *
 * <p>This class contains methods to handle Invasive Species Logic, a type of Base Logic
 * 
 ...
 */
  public void doInvasive() {
    ArrayList<simpplle.comcode.element.Evu> invasiveUnits = buildInvasiveList();
 ...
 */
   ...
   */
  private InvasiveSpeciesLogicData getMatchingLogicRule(simpplle.comcode.element.Evu evu, ArrayList<simpplle.comcode.element.Evu> invasiveUnits) {
  ...
  private InvasiveSpeciesChangeLogicData getMatchingChangeLogicRule(simpplle.comcode.element.Evu evu, InclusionRuleSpecies species) {
 ...
 */
  private ArrayList<simpplle.comcode.element.Evu> buildInvasiveList() {
    ArrayList<simpplle.comcode.element.Evu> invasiveUnits = new ArrayList<simpplle.comcode.element.Evu>();
