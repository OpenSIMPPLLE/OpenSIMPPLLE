...
//  }
  ...
  public ArrayList<simpplle.comcode.element.Roads.Status> roadStatusList;
  public String                  roadStatusDesc;
  public boolean                 defaultRoadStatusDesc;
  
  public ArrayList<simpplle.comcode.element.Trails.Status> trailStatusList;
  ...
  protected LogicData() {
    ...
    roadStatusList = new ArrayList<simpplle.comcode.element.Roads.Status>();
    trailStatusList = new ArrayList<simpplle.comcode.element.Trails.Status>();
  ...
  public void duplicate(LogicData logicData) {
    ...
    logicData.roadStatusList = new ArrayList<simpplle.comcode.element.Roads.Status>(roadStatusList);
    logicData.roadStatusDesc = roadStatusDesc;
    logicData.defaultRoadStatusDesc = defaultRoadStatusDesc;
    
    logicData.trailStatusList = new ArrayList<simpplle.comcode.element.Trails.Status>(trailStatusList);
  ...
  public void addListValueAt(int col, Object value) {
    switch (col) {
      ...
      case BaseLogic.ROAD_STATUS_COL:
        roadStatusList.add((simpplle.comcode.element.Roads.Status)value);
        break;
      case BaseLogic.TRAIL_STATUS_COL:
        trailStatusList.add((simpplle.comcode.element.Trails.Status)value);
        break;
  ...
  public void removeListValueAt(int col, Object value) {
    switch (col) {
      ...
      case BaseLogic.SPECIAL_AREA_COL:
        ...
        break;
      case BaseLogic.ROAD_STATUS_COL:
        roadStatusList.remove((simpplle.comcode.element.Roads.Status)value);
        break;
      case BaseLogic.TRAIL_STATUS_COL:
        trailStatusList.remove((simpplle.comcode.element.Trails.Status)value);
        break;
      case BaseLogic.LANDTYPE_COL:
 ...
 */
  public boolean hasListValue(int col, Object value) {
    switch (col) {
      ...
      case BaseLogic.ROAD_STATUS_COL:
        return roadStatusList.contains((simpplle.comcode.element.Roads.Status)value);
      case BaseLogic.TRAIL_STATUS_COL:
        return trailStatusList.contains((simpplle.comcode.element.Trails.Status)value);
      case BaseLogic.LANDTYPE_COL:
 ...
 */
  ...
  public void AddRuleData(LogicData logicData) {
    simpplle.comcode.utility.Utility.combineLists(speciesResistance,logicData.speciesResistance);
    setDescriptionDefault(SimpplleType.Types.SPECIES);
  }
/**
 ...
 */
  public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
    ...
    if (version == 12) {
      ...
      roadStatusList  = (ArrayList<simpplle.comcode.element.Roads.Status>)in.readObject();
      roadStatusDesc  = (String)in.readObject();
      defaultRoadStatusDesc = in.readBoolean();
      
      trailStatusList = (ArrayList<simpplle.comcode.element.Trails.Status>)in.readObject();
 ...
 */
  ...
  public boolean isMatch(simpplle.comcode.element.Evu evu, Lifeform life) {
    int cStep = Simulation.getCurrentTimeStep();
    return isMatch(evu,cStep,life);
  }
  public boolean isMatch(simpplle.comcode.element.Evu evu, Integer tStep, Lifeform lifeform) {
    FireResistance resistance =
  ...
  public boolean isMatch(FireResistance resistance, simpplle.comcode.element.Evu evu) {
    return isMatch(resistance,evu,null,null);
  }
  public boolean isMatch(FireResistance resistance, simpplle.comcode.element.Evu evu, Lifeform life) {
    int cStep = Simulation.getCurrentTimeStep();
  ...
  private boolean isMatch(FireResistance resistance, simpplle.comcode.element.Evu evu,
    ...
    if (roadStatusList != null && roadStatusList.size() > 0) {
      simpplle.comcode.element.Roads.Status status = evu.getRoadStatusNew();
      if (roadStatusList.contains(status) == false) {
        return false;
      }
    }
    if (trailStatusList != null && trailStatusList.size() > 0) {
      simpplle.comcode.element.Trails.Status status = evu.getTrailStatus();
  ...
  private boolean trackingSpeciesMatch(simpplle.comcode.element.Evu evu, Integer tStep) {
    if (tStep == null) {
  ...
  public void doAction(simpplle.comcode.element.Evu evu, Lifeform lifeform) {}
  public void doAction(simpplle.comcode.element.Evu evu) {}
