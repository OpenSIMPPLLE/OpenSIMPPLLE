 ...
 *
 * <p>This class contains methods for a Process Probability Logic Data.  
 * 
 ...
 */
  public Object getValueAt(int col) {
    switch (col) {
      case simpplle.comcode.logic.ProcessProbLogic.ADJ_PROCESS_COL:     return adjProcessDesc;
      case simpplle.comcode.logic.ProcessProbLogic.MPB_HAZARD_COL:    return mpbHazardList;
      case simpplle.comcode.logic.ProcessProbLogic.ADJ_MOD_HAZARD_COL:  return adjModHazard;
      case simpplle.comcode.logic.ProcessProbLogic.ADJ_HIGH_HAZARD_COL: return adjHighHazard;
      case simpplle.comcode.logic.ProcessProbLogic.PROB_COL:            return prob;
      default:
  ...
  public void setValueAt(int col, Object value) {
    switch (col) {
      case simpplle.comcode.logic.ProcessProbLogic.ADJ_PROCESS_COL:     break; // set in table editor
      case simpplle.comcode.logic.ProcessProbLogic.MPB_HAZARD_COL:    break; // set in table editor
      case simpplle.comcode.logic.ProcessProbLogic.ADJ_MOD_HAZARD_COL:
        if (adjModHazard != (Boolean)value) {
          adjModHazard = (Boolean) value;
          SystemKnowledge.markChanged(sysKnowKind);
        }
        break;
      case simpplle.comcode.logic.ProcessProbLogic.ADJ_HIGH_HAZARD_COL:
        if (adjHighHazard != (Boolean)value) {
          adjHighHazard = (Boolean) value;
          SystemKnowledge.markChanged(sysKnowKind);
        }
        break;
      case simpplle.comcode.logic.ProcessProbLogic.PROB_COL:
 ...
 */
  ...
  public Integer getProbability(simpplle.comcode.element.Evu evu) {
    if (isMatch(evu)) {
      return prob;
    }
    return null;
