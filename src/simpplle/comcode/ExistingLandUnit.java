...
public class ExistingLandUnit extends NaturalElement implements Externalizable {
  ...
  private ArrayList<Evu> assocVegUnits = new ArrayList<Evu>();  // Evu Class instances
 ...
 */
  ...
  public void addAssociatedVegUnit(Evu evu)  {
    if (assocVegUnits == null) { assocVegUnits = new ArrayList<Evu>(); }
 ...
 */
  ...
  protected void copyFrom(ExistingLandUnit copyUnit) {
    ...
    assocVegUnits  = new ArrayList<Evu>(copyUnit.assocVegUnits);
