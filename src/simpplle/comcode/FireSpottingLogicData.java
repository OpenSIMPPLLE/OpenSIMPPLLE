...
/**
 * This class defines Fire Spotting Logic Data, a type of Logic Data.  Elements used in the decisions for whether a fire will spot from one evu to another
...
public class FireSpottingLogicData extends LogicData implements Externalizable {
  ...
  public Object getValueAt(int col) {
    switch (col) {
      case FireEventLogic.FIRE_PROCESS_COL:  return fireProcess.getShortName();
      case FireEventLogic.SPREAD_TYPE_COL:   return fireSpreadType;
      case FireEventLogic.START_DIST_COL:    return startDist;
      case FireEventLogic.END_DIST_COL:      return endDist;
      case FireEventLogic.PROB_COL:          return prob;
  ...
  public void setValueAt(int col, Object value) {
    switch (col) {
      case FireEventLogic.FIRE_PROCESS_COL:
        ...
        break;
      case FireEventLogic.SPREAD_TYPE_COL:
 ...
 * @return
 */
  public boolean isMatch(Evu fromEvu, Evu toEvu, ProcessType simFireProcess, boolean isExtremeSpread) {
     ...
     * @return
     */
  private boolean isWithinDistanceZone(Evu fromEvu, Evu toEvu) {
   ...
   * @return
   */
  public static boolean isWithinMaxDistance(Evu fromEvu, Evu toEvu) {
    double distFeet = fromEvu.distanceToEvu(toEvu);
    double distMiles = distFeet / 5280.0;
    long   ratDistMiles = getRatDist(distMiles);
