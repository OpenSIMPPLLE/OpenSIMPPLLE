 ...
 *
 *
 * <p>This class provides methods to get and set Fire Regeneration data, this is a type of Regeneration Data.  It includes resprouting, adjacent resprouting, in place seed
 * in landscape seed and adjacent evu info.
 *
 * Fire Process logic
 8 determine all process probabilities for each evu ->use probabilities to select process
