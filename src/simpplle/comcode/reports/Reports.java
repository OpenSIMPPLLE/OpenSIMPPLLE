...
import simpplle.comcode.ProcessReports;
import simpplle.comcode.StateReports;
 ...
 *
 * <p>This class is the parent for all report classes.  It contains methods common to all reports
 * 
 ...
 */
    ...
    throws SimpplleError
  {
    ...
    simpplle.comcode.ProcessReports pReport = new simpplle.comcode.ProcessReports();
    simpplle.comcode.StateReports sReport = new simpplle.comcode.StateReports();
    TreatmentReports tReport = new TreatmentReports();
    simpplle.comcode.FireReports fReport = new simpplle.comcode.FireReports();
    ...
    throws SimpplleError
  {
    ...
    try {
      ...
      for (int i = 0; i < dataList.size(); i++) {
        ...
        String name = simpplle.comcode.utility.Utility.spacesToUnderscores(desc);
        File path;
 ...
 */
    ...
    throws SimpplleError
  {
    ...
    simpplle.comcode.ProcessReports pReport = new ProcessReports();
    simpplle.comcode.StateReports sReport = new StateReports();
    TreatmentReports tReport = new TreatmentReports();
    simpplle.comcode.FireReports fReport = new FireReports();
