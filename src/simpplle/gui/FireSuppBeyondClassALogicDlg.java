...
/** 
 * This class sets up Fire Suppression Beyond Class A Logic Dialog a type of vegetative logic Dialog.  Class A fire logic is fires within
 * 0-.25 Acres.
 * 
    ...
    for (int i = 0; i < panelKinds.length; i++) {
      ...
      tabPanels[i] =
          new FireSuppBeyondClassALogicPanel(this, kind,
                                       FireSuppBeyondClassALogic.getInstance(),
                                       sysKnowKind);
